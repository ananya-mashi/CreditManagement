...
">
<h2 class="text-white bg-dark"><marquee direction="left" Scrollamount=20 style="position:relative;">Select user for transaction
</marquee></h2>
 ...
 <div align="center">
			<div id="container">
		<h3>Transfer to:</h3>
	  <form:form method="Post" action="transferTo" modelAttribute="t">
	  <div style="overflow-x:auto;">
		<table >
		 	
   
    <c:forEach var="user" items="${users}">
      <c:url var="save" value="/transferTo/${t.id}/${user.name }"></c:url>
     <td>
<a type="button" class="btn btn-primary btn-md" href="${save}">${user.name}</a></td>
