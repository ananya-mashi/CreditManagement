...
">
<h2 class="text-white bg-dark"><marquee direction="left" Scrollamount=20 style="position:relative;">Welcome to Credit management Web Application
</marquee></h2>
<div class="container">
 ...
 <div class="panel panel-primary">
  <div class="panel-heading">
   <h3>Users List</h3>
   <a type="button" class="btn btn-primary btn-md" href="/history" style ="align:right;">>History of all transaction</a>
  </div>
