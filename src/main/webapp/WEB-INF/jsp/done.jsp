...
">
<h2 class="text-white bg-dark" style="font-size:2.8em;"><marquee direction="left" Scrollamount=20 style="position:relative;">You have Successfully Transferred Amount
</marquee></h2>
<div class="d-flex justify-content-center">
<img alt="gif" src="https://media.giphy.com/media/DjhVkIWFOdZAY/giphy.gif">
</div>
<br>
<br>
<div class="d-flex justify-content-center" style="font-size:5.8em;"> 
<a type="button" class="btn btn-primary btn-lg text" href="/user-list">Back to users list</a>
<a type="button" class="btn btn-primary btn-lg text" href="/history">All Transaction History</a>
</div>
