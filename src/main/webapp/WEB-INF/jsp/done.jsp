...
">
<h2 class="text-white bg-dark"><marquee direction="left" Scrollamount=20 style="position:relative;">You have successfully transferred money
</marquee></h2>
...
<a type="button" class="btn btn-primary btn-md" href="/">Back to user list</a>
</div>
